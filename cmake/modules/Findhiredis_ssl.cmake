if (HIREDIS_SSL_ROOT_DIR)
  SET(HIREDIS_SSL_PATHMODE "NO_DEFAULT_PATH")
else ()
  SET(HIREDIS_SSL_PATHMODE "")
endif ()

find_path(HIREDIS_SSL_INCLUDE_DIR NAMES hiredis/hiredis_ssl.h PATHS ${HIREDIS_SSL_ROOT_DIR} ${HIREDIS_SSL_ROOT_DIR}/include ${HIREDIS_SSL_PATHMODE})
find_library(HIREDIS_SSL_LIBRARIES NAMES hiredis_ssl PATHS ${HIREDIS_SSL_ROOT_DIR} ${HIREDIS_SSL_ROOT_DIR}/lib ${HIREDIS_SSL_PATHMODE})
