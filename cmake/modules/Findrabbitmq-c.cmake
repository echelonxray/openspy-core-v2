...
find_path(RABBITMQ_INCLUDE_DIR rabbitmq-c/amqp.h PATHS ${RABBITMQ_DIR} ${RABBITMQ_DIR}/include ${RABBITMQ_PATHMODE})
find_library(RABBITMQ_LIBRARIES NAMES rabbitmq PATHS ${RABBITMQ_DIR} ${RABBITMQ_DIR}/lib ${RABBITMQ_PATHMODE})
