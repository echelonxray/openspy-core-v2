if (HIREDIS_ROOT_DIR)
  SET(HIREDIS_PATHMODE "NO_DEFAULT_PATH")
else ()
  SET(HIREDIS_PATHMODE "")
endif ()

find_path(HIREDIS_INCLUDE_DIR NAMES hiredis/hiredis.h PATHS ${HIREDIS_OOT_DIR} ${HIREDIS_ROOT_DIR}/include ${HIREDIS_PATHMODE})
find_library(HIREDIS_LIBRARIES NAMES hiredis PATHS ${HIREDIS_ROOT_DIR} ${HIREDIS_ROOT_DIR}/lib ${HIREDIS_PATHMODE})
