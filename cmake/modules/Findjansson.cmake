if (JANSSON_ROOT_DIR)
  SET(JANSSON_PATHMODE "NO_DEFAULT_PATH")
else ()
  SET(JANSSON_PATHMODE "")
endif ()

find_path(JANSSON_INCLUDE_DIR NAMES jansson.h PATHS ${JANSSON_ROOT_DIR} ${JANSSON_PATHMODE})
find_library(JANSSON_LIBRARIES NAMES jansson PATHS ${JANSSON_ROOT_DIR} ${JANSSON_PATHMODE})
